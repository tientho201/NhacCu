...
import com.NhacCu.DAO.PhieuNhapHangDAO;
...
public class PhieuNhapHangBUS {
	...
	public boolean checkMaNV(String maNV) {
		for (PhieuNhapHangDTO pnh : ds) {
			if (pnh.getMaNhanVien().equals(maNV)) {
				return true ; 
			}
		}
		return false ; 
	...
	public boolean checkMaPNHvaMaNCCvaMaNVvaNgayNhap(String mapnh , String mancc , String manv , String ngaynhap) {
		for (PhieuNhapHangDTO pnh : ds) {
			if (pnh.getMaPNH().equals(mapnh) && pnh.getMaNCC().equals(mancc) &&  pnh.getMaNhanVien().equals(manv) && pnh.getNgayNhap().equals(ngaynhap)) {
				return true ; 
			}
		}
		return false ; 
